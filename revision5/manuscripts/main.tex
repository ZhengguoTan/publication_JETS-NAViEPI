...
\begin{document}
    ...
    \marginnote{R1116.9a)}
    We tested values of \hl{\mbox{$0$}, \mbox{$0.01$}, and \mbox{$0.02$}}.
    ...
    from Protocols \mbox{\#3} and \mbox{\#2} in \mbox{\cref{TAB:ACQ}}
    are displayed in \mbox{\cref{FIG:ablation}} (B) and
