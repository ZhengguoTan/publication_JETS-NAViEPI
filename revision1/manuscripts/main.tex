...
\begin{document}
    ...
    are \hl{used} because of two reasons. \marginnote{R1.20}
    ...
    \hl{single shot images} \marginnote{R3.16}
    ...
    $\mathbf{1}$ denotes the matrix of \hl{all ones} \marginnote{R3.11}
    with the same shape as \hl{the input}. \marginnote{R3.31}
