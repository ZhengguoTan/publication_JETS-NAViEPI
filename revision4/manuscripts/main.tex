...
\begin{document}
    ...
    \begin{enumerate}[I.]
        ...
        \marginnote{R1071.9}
        \hl{As the local patch window varies depending on
    ...
    \marginnote{R1071.12}
    \hl{and partially removes phase variation}.
    ...
    Here, the block width of $3$ shows the best denoising
    ...
    in the spatial-diffusion dimension \mbox{\citep{moeller_2021_nordic}},
